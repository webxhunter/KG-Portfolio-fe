      ...
      <div className="flex flex-wrap justify-center gap-4 mb-4">
        {navigationLinks.slice(0, 4).map((link, index) => (
          <Link key={index} href={link.href}>
            <button className="group inline-flex items-center gap-3 rounded-full px-6 py-3 text-white font-medium tracking-wide transition-all duration-300 cursor-pointer hover:scale-105 hover:bg-white/10"
