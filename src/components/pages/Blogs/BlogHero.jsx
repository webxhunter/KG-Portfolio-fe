...
import BlogHeroBg from '@/Assets/Blog/blog-kg-hero-img.png';
...
const BlogHero = () => {
  return (
    <section className="py-5 px-5 bg-black text-white">
      ...
      <div 
        className="bg-cover bg-center bg-no-repeat h-[65vh] max-[427px]:h-[40vh] flex items-end justify-center text-center p-8 w-screen -ml-[50vw] left-1/2 relative"
